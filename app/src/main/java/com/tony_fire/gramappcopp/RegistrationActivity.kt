...
import com.tony_fire.gramappcopp.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.lkdfpe.setOnClickListener {
            ...
            binding.lkdfpe.setBackgroundResource(R.drawable.bg_color_select)
            binding.lkdfpe.isEnabled = false

            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f9955e25cb3ff75e3cfcce8",ed2stName,ed_tel,"grentonprtfg")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                ...
                                startActivity(i)
                                binding.lkdfpe.setBackgroundResource(R.drawable.bg_selector)
                                binding.lkdfpe.isEnabled = true
                            }
